...
export const TEACHER_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      /*
       * Следващите routes ще добавяме,
       * когато създадем съответните страници.
       *
       * {
       *   path: 'resources/new',
       ...
       *   loadComponent: () =>
       *     import(
       *       './pages/add-resource/add-resource'
       ...
       *   loadComponent: () =>
       *     import(
       *       './pages/edit-resource/edit-resource'
       ...
       *   loadComponent: () =>
       *     import(
       *       './pages/teacher-resource-details/teacher-resource-details'
